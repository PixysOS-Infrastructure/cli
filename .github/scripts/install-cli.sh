...
# Check if both version and build-id are defined
if [ "$#" -lt 2 ]; then
    echo "Usage: $0 <version> <build-id>"
    exit 1
fi
...
URL="https://github.com/PixysOS-Infrastructure/cli/releases/download/release%2F${VERSION}/pixys.cli.${VERSION}.${BUILD_ID}.${ARCH}"
